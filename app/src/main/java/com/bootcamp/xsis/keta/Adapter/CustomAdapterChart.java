...
public class CustomAdapterChart extends RecyclerView.Adapter<CustomAdapterChart.Holder> {
    ...
    public CustomAdapterChart(List<showMenu> mListData, Context mContext){
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_list_view_chart_custom,null);
    ...
    public void onBindViewHolder(Holder holder, int position) {
        ...
        holder.qtynya.setText(String.valueOf(model.getQuantity()));
    ...
    public class Holder extends RecyclerView.ViewHolder {
        ...
        public TextView name_product,price_product,qtynya,subtotal;
        ...
        public Holder(View itemView) {
            ...
            icon_product = (ImageView) itemView.findViewById(R.id.icon_chart);
            name_product = (TextView) itemView.findViewById(R.id.name_chart);
            price_product = (TextView) itemView.findViewById(R.id.price_chart);
            qtynya = (TextView) itemView.findViewById(R.id.qtynya);
